...
const AccountModal = ({ isOpen, onClose }) => {
    ...
    const handleSave = async () => {
        ...
        await postData('/account/admin-account', body, token)
          .then((resp) => {
            if (resp) {
              const templateParams = {
                ...
                user_name: 'Onlearn',
                message:
                  'Đây là thông tin tài khoản quản trị viên của bạn: \n Tài khoản: ' +
                  account.username +
                  ' \n Mật khẩu: ' +
                  account.password +
                  ' .',
    ...
    return (
        <Dialog open={isOpen} onClose={onClose} maxWidth="sm" fullWidth>
            <div className="d-flex justify-content-sm-between">
                <DialogTitle>{'Thêm mới tài khoản quản trị viên'}</DialogTitle>
                <div className="p-3">
