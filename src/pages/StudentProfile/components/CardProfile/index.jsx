                  ...
                  <div className="d-flex justify-content-center p-2">
                    <div style={{ border: '1px dashed rgba(145, 158, 171, 0.46)' }} className="p-2  rounded-circle">
                      <Avatar
                        ...
                        alt={info?.account?.profile?.firstName}
                        src={info?.account?.profile?.avatar}
                      />
                    </div>
                  </div>
                  <Typography style={{ fontWeight: 700, textAlign: 'center' }}>@{info?.account?.username}</Typography>
                </div>
                <Typography style={{ fontWeight: 700, color: 'grey', textAlign: 'center' }}>
                  {info?.account?.role === "STUDENT" ? 'HỌC VIÊN' : 'GIẢNG VIÊN'}
                </Typography>
              </CardContent>
