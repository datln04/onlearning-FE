...
import AccountSubjectView from './AccountSubjectView';

/**
 * The StaffSubjectView model module.
 * @module model/StaffSubjectView
 * @version v1
 */
class StaffSubjectView {
    /**
     * Constructs a new <code>StaffSubjectView</code>.
     * @alias module:model/StaffSubjectView
     */
    constructor() { 
        
        StaffSubjectView.initialize(this);
    }
    ...
    /**
     * Constructs a <code>StaffSubjectView</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StaffSubjectView} obj Optional instance to populate.
     * @return {module:model/StaffSubjectView} The populated <code>StaffSubjectView</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StaffSubjectView();
            ...
            if (data.hasOwnProperty('account')) {
                obj['account'] = AccountSubjectView.constructFromObject(data['account']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>StaffSubjectView</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StaffSubjectView</code>.
     */
    static validateJSON(data) {
        ...
        if (data['account']) { // data not null
          AccountSubjectView.validateJSON(data['account']);
        }
        // ensure the json data is a string
 ...
 * @member {Number} id
 */
StaffSubjectView.prototype['id'] = undefined;

/**
 * @member {String} staffNumber
 */
StaffSubjectView.prototype['staffNumber'] = undefined;

/**
 * @member {module:model/AccountSubjectView} account
 */
StaffSubjectView.prototype['account'] = undefined;

/**
 * @member {String} bankName
 */
StaffSubjectView.prototype['bankName'] = undefined;

/**
 * @member {String} cardNumber
 */
StaffSubjectView.prototype['cardNumber'] = undefined;

/**
 * @member {String} cardHolderName
 */
StaffSubjectView.prototype['cardHolderName'] = undefined;
...
export default StaffSubjectView;
