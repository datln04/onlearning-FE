...
/**
 * The WalletTransactionView model module.
 * @module model/WalletTransactionView
 * @version v1
 */
class WalletTransactionView {
    /**
     * Constructs a new <code>WalletTransactionView</code>.
     * @alias module:model/WalletTransactionView
     */
    constructor() { 
        
        WalletTransactionView.initialize(this);
    }
    ...
    /**
     * Constructs a <code>WalletTransactionView</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/WalletTransactionView} obj Optional instance to populate.
     * @return {module:model/WalletTransactionView} The populated <code>WalletTransactionView</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WalletTransactionView();
    ...
    /**
     * Validates the JSON data with respect to <code>WalletTransactionView</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WalletTransactionView</code>.
     */
 ...
 * @member {Number} id
 */
WalletTransactionView.prototype['id'] = undefined;

/**
 * @member {Number} amount
 */
WalletTransactionView.prototype['amount'] = undefined;

/**
 * @member {String} bankNumber
 */
WalletTransactionView.prototype['bankNumber'] = undefined;

/**
 * @member {String} bankName
 */
WalletTransactionView.prototype['bankName'] = undefined;

/**
 * @member {module:model/AccountTransactionView} account
 */
WalletTransactionView.prototype['account'] = undefined;

/**
 * @member {String} walletType
 */
WalletTransactionView.prototype['walletType'] = undefined;
