...
/**
 * The StaffSyllabusView model module.
 * @module model/StaffSyllabusView
 * @version v1
 */
class StaffSyllabusView {
    /**
     * Constructs a new <code>StaffSyllabusView</code>.
     * @alias module:model/StaffSyllabusView
     */
    constructor() { 
        
        StaffSyllabusView.initialize(this);
    }
    ...
    /**
     * Constructs a <code>StaffSyllabusView</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StaffSyllabusView} obj Optional instance to populate.
     * @return {module:model/StaffSyllabusView} The populated <code>StaffSyllabusView</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StaffSyllabusView();
    ...
    /**
     * Validates the JSON data with respect to <code>StaffSyllabusView</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StaffSyllabusView</code>.
     */
 ...
 */
StaffSyllabusView.prototype['staffNumber'] = undefined;

/**
 * @member {module:model/AccountSyllabusView} account
 */
StaffSyllabusView.prototype['account'] = undefined;

/**
 * @member {String} bankName
 */
StaffSyllabusView.prototype['bankName'] = undefined;

/**
 * @member {String} cardNumber
 */
StaffSyllabusView.prototype['cardNumber'] = undefined;

/**
 * @member {String} cardHolderName
 */
StaffSyllabusView.prototype['cardHolderName'] = undefined;
...
export default StaffSyllabusView;
