...
/**
 * The StaffFeedbackView model module.
 * @module model/StaffFeedbackView
 * @version v1
 */
class StaffFeedbackView {
    /**
     * Constructs a new <code>StaffFeedbackView</code>.
     * @alias module:model/StaffFeedbackView
     */
    constructor() { 
        
        StaffFeedbackView.initialize(this);
    }
    ...
    /**
     * Constructs a <code>StaffFeedbackView</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StaffFeedbackView} obj Optional instance to populate.
     * @return {module:model/StaffFeedbackView} The populated <code>StaffFeedbackView</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StaffFeedbackView();
    ...
    /**
     * Validates the JSON data with respect to <code>StaffFeedbackView</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StaffFeedbackView</code>.
     */
 ...
 */
StaffFeedbackView.prototype['staffNumber'] = undefined;

/**
 * @member {module:model/AccountFeedbackView} account
 */
StaffFeedbackView.prototype['account'] = undefined;

/**
 * @member {String} bankName
 */
StaffFeedbackView.prototype['bankName'] = undefined;

/**
 * @member {String} cardNumber
 */
StaffFeedbackView.prototype['cardNumber'] = undefined;

/**
 * @member {String} cardHolderName
 */
StaffFeedbackView.prototype['cardHolderName'] = undefined;
