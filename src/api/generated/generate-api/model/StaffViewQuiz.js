...
/**
 * The StaffViewQuiz model module.
 * @module model/StaffViewQuiz
 * @version v1
 */
class StaffViewQuiz {
    /**
     * Constructs a new <code>StaffViewQuiz</code>.
     * @alias module:model/StaffViewQuiz
     */
    constructor() { 
        
        StaffViewQuiz.initialize(this);
    }
    ...
    /**
     * Constructs a <code>StaffViewQuiz</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StaffViewQuiz} obj Optional instance to populate.
     * @return {module:model/StaffViewQuiz} The populated <code>StaffViewQuiz</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StaffViewQuiz();
    ...
    /**
     * Validates the JSON data with respect to <code>StaffViewQuiz</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StaffViewQuiz</code>.
     */
 ...
 */
StaffViewQuiz.prototype['staffNumber'] = undefined;

/**
 * @member {module:model/AccountViewQuiz} account
 */
StaffViewQuiz.prototype['account'] = undefined;

/**
 * @member {String} bankName
 */
StaffViewQuiz.prototype['bankName'] = undefined;

/**
 * @member {String} cardNumber
 */
StaffViewQuiz.prototype['cardNumber'] = undefined;

/**
 * @member {String} cardHolderName
 */
StaffViewQuiz.prototype['cardHolderName'] = undefined;
