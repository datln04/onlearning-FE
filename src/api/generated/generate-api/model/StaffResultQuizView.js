...
/**
 * The StaffResultQuizView model module.
 * @module model/StaffResultQuizView
 * @version v1
 */
class StaffResultQuizView {
    /**
     * Constructs a new <code>StaffResultQuizView</code>.
     * @alias module:model/StaffResultQuizView
     */
    constructor() { 
        
        StaffResultQuizView.initialize(this);
    }
    ...
    /**
     * Constructs a <code>StaffResultQuizView</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StaffResultQuizView} obj Optional instance to populate.
     * @return {module:model/StaffResultQuizView} The populated <code>StaffResultQuizView</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StaffResultQuizView();
    ...
    /**
     * Validates the JSON data with respect to <code>StaffResultQuizView</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StaffResultQuizView</code>.
     */
 ...
 */
StaffResultQuizView.prototype['staffNumber'] = undefined;

/**
 * @member {module:model/AccountResultQuizView} account
 */
StaffResultQuizView.prototype['account'] = undefined;

/**
 * @member {String} bankName
 */
StaffResultQuizView.prototype['bankName'] = undefined;

/**
 * @member {String} cardNumber
 */
StaffResultQuizView.prototype['cardNumber'] = undefined;

/**
 * @member {String} cardHolderName
 */
StaffResultQuizView.prototype['cardHolderName'] = undefined;
...
export default StaffResultQuizView;
