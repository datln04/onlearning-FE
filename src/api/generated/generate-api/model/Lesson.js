...
class Lesson {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('syllabuses')) {
                obj['syllabuses'] = ApiClient.convertToType(data['syllabuses'], [Syllabus]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>Lesson</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Lesson</code>.
     */
    static validateJSON(data) {
        ...
        if (data['resources']) { // data not null
            ...
            for (const item of data['resources']) {
                Resource.validateJsonObject(item);
            };
        }
        if (data['syllabuses']) { // data not null
            ...
            for (const item of data['syllabuses']) {
                Syllabus.validateJsonObject(item);
            };
        }
 ...
 */
Lesson.prototype['description'] = undefined;

/**
 * @member {String} url
 */
Lesson.prototype['url'] = undefined;

/**
 * @member {Date} dateTime
 */
Lesson.prototype['dateTime'] = undefined;

/**
 * @member {Number} estimateTime
 */
Lesson.prototype['estimateTime'] = undefined;

/**
 * @member {String} content
 */
Lesson.prototype['content'] = undefined;

/**
 * @member {module:model/Lesson.TypeEnum} type
 */
Lesson.prototype['type'] = undefined;

/**
 * @member {module:model/Course} course
 */
Lesson.prototype['course'] = undefined;

/**
 * @member {Array.<module:model/Resource>} resources
 */
Lesson.prototype['resources'] = undefined;

/**
 * @member {Array.<module:model/Syllabus>} syllabuses
 */
Lesson.prototype['syllabuses'] = undefined;
